...
class AttachmentViewerTests(TestCase):
    ...
    def test_cad_superuser_gets_200(self):
        ...
        self.assertContains(response, 'cad-preview/index.js')
        self.assertContains(response, 'type="importmap"')
        self.assertContains(response, 'type="module"')
        self.assertContains(response, 'three.module.min.js')
        self.assertContains(response, 'core-0.185.1')
        self.assertContains(response, 'three-bvh-csg')
        self.assertNotContains(response, 'three.min.js')
        self.assertNotContains(response, 'cad_preview.js')
        self.assertNotContains(response, 'core-0.149.0')
        self.assertNotContains(response, 'core-0.179.0')
        self.assertContains(response, 'data-cad-tree-panel')
        self.assertContains(response, 'data-cad-tree-search')
        self.assertContains(response, 'data-cad-tree-stats')
        self.assertContains(response, 'data-cad-tree-filter')
        self.assertContains(response, 'data-cad-action="tree-expand-all"')
        self.assertContains(response, 'data-cad-action="tree-collapse-all"')
        self.assertContains(response, 'data-cad-action="tree-filter"')
        ...
        self.assertContains(response, 'data-cad-shot-panel')
        self.assertContains(response, 'data-cad-action="shot-export"')
        self.assertContains(response, 'data-cad-action="shot-close"')
        self.assertContains(response, 'data-cad-action="xray"')
        self.assertContains(response, 'data-cad-action="dark"')
        self.assertContains(response, 'data-cad-action="display-panel"')
        self.assertContains(response, 'data-cad-display-panel')
        self.assertContains(response, 'data-cad-action="part-color"')
        self.assertContains(response, 'data-cad-action="part-color-reset"')
        self.assertContains(response, 'data-cad-action="part-color-reset-all"')
        self.assertContains(response, 'data-cad-shot="measure"')
        self.assertContains(response, 'data-cad-shot="helpers"')
        self.assertContains(response, 'data-cad-shot="highlight"')
        self.assertContains(response, 'data-cad-shot="alpha"')
        self.assertContains(response, 'data-cad-action="shot-scale"')
        self.assertContains(response, 'data-cad-action="shot-size"')
        ...
        self.assertContains(response, 'data-cad-section="azimuth"')
        self.assertContains(response, 'data-cad-section="elevation"')
        self.assertContains(response, 'data-cad-section="offset"')
        self.assertContains(response, 'data-cad-section="flip"')
        self.assertContains(response, 'data-cad-section="list"')
        self.assertContains(response, 'data-cad-section="targets"')
        self.assertNotContains(response, 'data-cad-section="selected"')
        self.assertContains(response, 'data-cad-action="section-add"')
        self.assertContains(response, 'data-cad-action="section-commit"')
        self.assertContains(response, 'data-cad-action="section-pivot"')
        self.assertNotContains(response, 'data-cad-section="slab"')
        self.assertNotContains(response, 'data-cad-section="thickness"')
        self.assertNotContains(response, 'data-cad-section="caps"')
        self.assertNotContains(response, 'data-cad-section-slab-lock')
        self.assertNotContains(response, 'data-cad-section="extra"')
        self.assertNotContains(response, 'data-cad-action="section-extra-axis"')
        self.assertContains(response, 'data-cad-explode-panel')
        self.assertContains(response, 'data-cad-action="measure"')
        self.assertContains(response, 'data-cad-measure-panel')
        self.assertContains(response, 'data-cad-action="light-kind"')
        self.assertContains(response, 'data-cad-light-kind="area"')
        self.assertContains(response, 'data-cad-light-kind="point"')
        self.assertContains(response, 'data-cad-light="distance"')
        self.assertContains(response, 'data-cad-light="gloss"')
        self.assertContains(response, 'data-cad-light="roughness"')
        self.assertContains(response, 'data-cad-light="metalness"')
        self.assertContains(response, 'data-cad-light="clearcoat"')
        self.assertContains(response, 'data-cad-light="clearcoat-roughness"')
        self.assertContains(response, 'data-cad-light="intensity"')
        self.assertContains(response, 'max="2.50"')
        self.assertContains(response, 'data-cad-action="measure-clear"')
        self.assertContains(response, 'data-cad-measure="list"')
        self.assertContains(response, 'data-cad-measure-label')
