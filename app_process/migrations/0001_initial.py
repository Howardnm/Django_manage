    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_code', models.IntegerField(blank=True, null=True, verbose_name='机台号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='如：PP+滑石粉 高剪切组合-V1', max_length=100, verbose_name='组合名称')),
                ('description', models.TextField(blank=True, help_text='详细描述螺杆排列逻辑，如：输送-熔融-剪切-排气', verbose_name='组合描述')),
                ('drawing_file', models.FileField(blank=True, help_text='上传螺杆排列图 (PDF/图片)', null=True, upload_to=common_utils.upload_file_path.upload_file_path, verbose_name='组合图纸')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('process_type_name', models.CharField(default='双螺杆挤出', help_text='如：双螺杆挤出、其他', max_length=50, verbose_name='工艺类型')),
                ...
                ('screen_mesh', models.CharField(blank=True, help_text='如：80/100', max_length=50, verbose_name='过滤网目数')),
                ...
                ('material_types', models.ManyToManyField(blank=True, related_name='process_profiles', to='app_repository.materialtype', verbose_name='适用材料类型')),
