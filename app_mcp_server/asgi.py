"""MCP Streamable HTTP ASGI：JWT 鉴权、CORS、session lifespan。
...
from app_mcp_server.auth import JwtAuthError, authenticate_http
...
class MCPASGIApp:
    """ASGI wrapper: JWT Bearer auth + CORS around StreamableHTTPSessionManager."""
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        try:
            await sync_to_async(authenticate_http)(request)
        except JwtAuthError:
