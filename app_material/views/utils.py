...
from ..models.material import MaterialType, ApplicationScenario, MaterialLibrary, TestConfig
...
class MaterialAutocompleteView(View):
    ...
    def get(self, request):
        ...
        # 5. 应用场景
        elif model_type == 'applicationscenario' or model_type == 'scenario':
